...
SGIE1_CONFIG_FILE_PATH = "/code/deepstream_test2_app/dstest2_sgie1_config.yml"
...
def main(file_path):
    ...
    if file_ext in [".yaml", ".yml"]:
        ...
        (Pipeline(PIPELINE_NAME).add("filesrc", "src", {"location": file_path}).add("h264parse", "parser").add("nvv4l2decoder", "decoder")
            ...
            .link("src", "parser", "decoder").link(("decoder", "mux"), ("", "sink_%u")).link("mux","pgie", "tracker", "sgie1", "osd", "sink")
